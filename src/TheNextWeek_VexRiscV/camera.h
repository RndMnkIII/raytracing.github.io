...
//   • std::tan, std::sqrt, std::fabs use float overloads from compat/cmath
//
// Program logic: UNCHANGED  (background color, emission, ray_time, defocus).
//==============================================================================================
...
class camera {
  public:
    ...
    int    image_width       = 160;   // Rendered image width — reduced for embedded
    ...
    float  focus_dist    = 10.0f; // Distance from lookfrom point to plane of perfect focus
