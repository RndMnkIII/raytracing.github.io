...
//   • double t, u, v → float t, u, v  in hit_record
//   • double sin_theta, cos_theta → float in rotate_y
//   • Floating-point literals: added 'f' suffix throughout
//   • std::sin, std::cos, std::fmin, std::fmax use float overloads from compat/cmath
//==============================================================================================
